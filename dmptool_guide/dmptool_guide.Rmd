...
```{r, echo=FALSE, fig.cap="*Figure 1: Sign into DMPTool via institution*"}
...
```{r, echo=FALSE, fig.cap="*Figure 2: Look up CU Boulder and sign in via Identikey*"}
...
```{r, echo=F, fig.cap="*Figure 6: DMP sections*"}
