...
```{r, echo=FALSE, fig.cap="*Figure 1: Go to the DMPTool website and select the option to sign in via institution*"}
...
```{r, echo=FALSE, fig.cap="*Figure 2: Look up CU Boulder and click the Go button to sign in via Identikey*"}
...
```{r, echo=FALSE, fig.cap="*Figure 3: Create a new plan*"}
...
```{r, echo=FALSE, fig.cap="*Figure 4: Buttons corresponding to plan sections and section guidance*" }
...
```{r, echo=FALSE, fig.cap="*Figure 5: Invite collaborators*"}
...
```{r, echo=F, fig.cap="*Figure 6: Plan Sections*"}
...
```{r, echo=F, fig.cap="*Figure 7: Individual DMP Section*"}
...
```{r, echo=F, fig.cap="*Figure 10: Access DMP from DMPTool dashboard*"}
